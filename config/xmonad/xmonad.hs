...
text_editor			= spawn "code"
web_browser			= spawn "brave"

-- Rofi Menus
rofi_asroot 		= spawn "rofi -show drun"
rofi_launcher 		= spawn "rofi -show drun"
rofi_mpd 			= spawn "rofi -show drun"
rofi_network_menu 	= spawn "rofi -show drun"
rofi_powermenu 		= spawn "rofi -show drun"
rofi_screenshot 	= spawn "rofi -show drun"
rofi_windows 		= spawn "rofi -show drun"
...
myKeys conf@(XConfig {XMonad.modMask = super}) = M.fromList $
    ...
    , ((super .|. shiftMask, 		xK_q), 		text_editor)
    ...
    , ((super .|. shiftMask, 	xK_g), sendMessage $ setGaps [(L,40), (R,40), (U,40), (D,40)]) 	-- reset the GapSpec
