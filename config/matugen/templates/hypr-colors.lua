...
local colors = {
	...
	blue_source = "{{colors.blue_source.default.hex}}",
	blue_value = "{{colors.blue_value.default.hex}}",
	...
	green_source = "{{colors.green_source.default.hex}}",
	green_value = "{{colors.green_value.default.hex}}",
	...
	on_orange = "{{colors.on_orange.default.hex}}",
	on_orange_container = "{{colors.on_orange_container.default.hex}}",
	...
	on_purple = "{{colors.on_purple.default.hex}}",
	on_purple_container = "{{colors.on_purple_container.default.hex}}",
	...
	orange_container = "{{colors.orange_container.default.hex}}",
	orange_source = "{{colors.orange_source.default.hex}}",
	orange_value = "{{colors.orange_value.default.hex}}",
	...
	purple_container = "{{colors.purple_container.default.hex}}",
	purple_source = "{{colors.purple_source.default.hex}}",
	purple_value = "{{colors.purple_value.default.hex}}",
	red = "{{colors.red.default.hex}}",
	red_container = "{{colors.red_container.default.hex}}",
	red_source = "{{colors.red_source.default.hex}}",
	red_value = "{{colors.red_value.default.hex}}",
	...
	yellow_source = "{{colors.yellow_source.default.hex}}",
	yellow_value = "{{colors.yellow_value.default.hex}}",
}
