...
local hotkeys_popup_list = require("layout.others.hotkeys_list")
local keys = {}
...
awful.key({modkey}, "e", function()
    ...
    if theme == themes[1] then
        awful.spawn
            .easy_async_with_shell("rofi -show window -theme " .. "~/.config/rofi/gruvbox.rasi" .. " -show-icons")
    elseif theme == themes[2] then
        awful.spawn.easy_async_with_shell("rofi -show window -theme " .. "~/.config/rofi/light.rasi" .. " -show-icons")
...
awful.key({}, "XF86AudioRaiseVolume", function()
    awful.spawn.easy_async_with_shell(helpers.volume_control(5))
end, {
    ...
    awful.spawn.easy_async_with_shell(helpers.volume_control(0))
end, {
...
awful.key({modkey, "Control"}, "Print", function()
    awful.spawn.easy_async_with_shell(apps.utils.recorded, function()
    end)
end, {
    description = "take a area recorded",
    group = "hotkeys"
...
awful.key({modkey}, "q", function()
    ...
    awful.spawn.easy_async_with_shell(apps.utils.blue_light, function()
    end)
end, {
...
awful.key({modkey}, "r", function()
    if theme == themes[1] then
        awful.spawn.easy_async_with_shell("rofi -show drun -theme " .. "~/.config/rofi/gruvbox.rasi" .. " -show-icons")
    elseif theme == themes[2] then
        awful.spawn.easy_async_with_shell("rofi -show drun -theme " .. "~/.config/rofi/light.rasi" .. " -show-icons")
    elseif theme == themes[3] then
        awful.spawn.easy_async_with_shell("rofi -show drun -theme " .. "~/.config/rofi/dark.rasi" .. " -show-icons")
    end
end, {
