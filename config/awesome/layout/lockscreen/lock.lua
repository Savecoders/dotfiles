...
local clock = wibox.widget{
    ...
    {
        font = beautiful.font,
        format = helpers.colorize_text("%I:%M", beautiful.bg),
...
local wrong_password = wibox.widget{
    widget = wibox.widget.textbox,
    markup = "<span foreground='" .. beautiful.red .. "'>Password Incorrect!</span>",
    font = beautiful.font,
    align = "center",
    valign = "center",
    visible = false,
...
local function key_animation(char_inserted)
    ...
    icon.markup = "<span foreground='" .. beautiful.fg_normal .. "'>" .. lock_screen_symbol .. "</span>"
    pfp_overlay.bg = "#000"
