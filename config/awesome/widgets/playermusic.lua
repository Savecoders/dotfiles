...
local song_artist = wibox.widget{
    ...
    markup = helpers.colorize_text("Unknown", beautiful.red),
...
local song_name = wibox.widget{
    widget = wibox.widget.textbox,
    markup = helpers.colorize_text("None", beautiful.icon_bg),
    ...
    {
        {
            {
                widget = wibox.widget.textbox,
                markup = helpers.colorize_text("", beautiful.icon_bg),
            ...
            {
                widget = wibox.widget.textbox,
                id = "music_text_role",--icon_bg
                markup = helpers.colorize_text("Music", beautiful.icon_bg),
...
playerctl:connect_signal("metadata", function(_, title, artist, album_path, _, __, player_name)
	...
	if album_path == "" then
		album_path = beautiful.album_art
	end
    if player_name == "" then
        player_name = "None"
    end
    ...
    song_name:set_markup_silently(helpers.colorize_text(title, beautiful.icon_bg))
	song_artist:set_markup_silently(helpers.colorize_text(artist, beautiful.icon_bg))
    music_display:get_children_by_id("music_text_role")[1].markup = helpers.colorize_text(player_name, beautiful.icon_bg)
